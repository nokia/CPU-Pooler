...
// NewCheckpointPodDevicesEntry is representing Pod specific deviceID allocations from kubelet checkpoint file structure - valid from K8s 1.21 onward
// Reference: https://github.com/kubernetes/kubernetes/commit/a8b8995ef241e93e9486d475126450f33f24ef4e
type NewCheckpointPodDevicesEntry struct {
	PodUID        string
	ContainerName string
	ResourceName  string
...
type NewCheckpointFile struct {
	Data struct {
		PodDeviceEntries []NewCheckpointPodDevicesEntry
	}
}
